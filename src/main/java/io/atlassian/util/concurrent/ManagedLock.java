...
/**
 * {@link io.atlassian.util.concurrent.ManagedLock} allows {@link Callable callables}, {@link Runnable
...
public interface ManagedLock {
  /**
   * Execute the supplied {@link java.util.concurrent.Callable} under a lock determined by the
   * descriptor.
   *
   ...
   * @throws java.lang.Exception if the supplied {@link java.util.concurrent.Callable} throws an exception
   */
  <R> R withLock(final @NotNull Callable<R> callable) throws Exception;

  /**
   * Execute the supplied {@link java.util.function.Supplier} under a lock determined by the
   * descriptor.
   * <p>
  ...
  /**
   * Execute the supplied {@link java.lang.Runnable} under a lock determined by the
   * descriptor.
   *
