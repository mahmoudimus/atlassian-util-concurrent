 ...
 * can optionally block until elements are available or throw {@link RuntimeException runtime
 * exceptions} if the input is not acceptable for some reason. Any clients that require a firmer
 * contract should subclass this interface and document their requirements.
 * <p>
 * It is expected that for any two calls to {@link #get(Object)} D the returned resource will be
 ...
 * instance or even implements {@link #equals(Object)} and {@link #hashCode()} however.
 * <p>
