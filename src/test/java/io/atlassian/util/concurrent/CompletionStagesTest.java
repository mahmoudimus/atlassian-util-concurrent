...
import static io.atlassian.util.concurrent.CompletionStages.getCompletionStageValue;
...
public class CompletionStagesTest {
  ...
  @Test public void getCompletionStageValueReturnsValue() {
    ...
    assertThat(getCompletionStageValue(completionStage, throwable -> "no"), equalTo(value));
  }
  ...
  @Test public void getCompletionStageValueInvokesErrorFunction() {
    ...
    assertThat(getCompletionStageValue(completionStage, throwable -> value), equalTo(value));
  }
  ...
  @Test public void getCompletionStageValueWithTimeoutReturnsValue() {
    ...
    assertThat(getCompletionStageValue(completionStage, 10, TimeUnit.MILLISECONDS, throwable -> "no"), equalTo(value));
  }
  ...
  @Test public void getCompletionStageValueWithTimeoutInvokesErrorFunction() {
    ...
    assertThat(getCompletionStageValue(completionStage, 10, TimeUnit.MILLISECONDS, throwable -> value), equalTo(value));
  }
