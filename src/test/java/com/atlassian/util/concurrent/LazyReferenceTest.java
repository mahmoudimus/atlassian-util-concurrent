    ...
    public void concurrentCreate() throws Exception {
        ...
        final LazyReference<Object> ref = new LazyReference<Object>() {
            ...
            protected Object create() {
                /*
                 * We are trying to simulate an expensive object construction
                 * call. So we do a sleep here. The idea is that we will get
                 * many threads to call create() at the same time, make create
                 * "slow" and then ensure that create() method was indeed
                 * invoked only once.
                 */
        ...
        /*
         * pool size must be large enough to accommodate all Callables running
         * in parallel as they latch
         */
        ...
        for (int i = 0; i < nThreads; i++) {
            ...
            tasks.add(new Callable<Object>() {
                public Object call() throws Exception {
                    /*
                     * Put in a latch to synchronize all threads and try to get
                     * them to call ref.get() at the same time (to increase
                     * concurrency and make this test more useful)
                     */
                    latch.countDown();
                    latch.await();
                    results[j] = ref.get();
        ...
        /*
         * Ensure that all the references are the same, use the futures in case
         * of exception
         */
