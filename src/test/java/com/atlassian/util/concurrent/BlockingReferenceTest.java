...
public class BlockingReferenceTest {
  ...
  @Test public void simpleSRSWReference() throws Exception {
    assertSimple(BlockingReference.<String> newSRSW());
  }

  @Test public void simpleMRSWReference() throws Exception {
    assertSimple(BlockingReference.<String> newMRSW());
  }

  @Test public void simpleSRSWReferenceNull() throws Exception {
    assertSimple(BlockingReference.<String> newSRSW(null));
  }

  @Test public void simpleMRSWReferenceNull() throws Exception {
  ...
  @Test(expected = TimeoutException.class) public void timeoutSRSWReferenceGet() throws Exception {
    final BlockingReference<String> ref = BlockingReference.newSRSW();
    ref.get(1, TimeUnit.NANOSECONDS);
  }

  @Test(expected = TimeoutException.class) public void timeoutSRSWReferenceTake() throws Exception {
    final BlockingReference<String> ref = BlockingReference.newSRSW();
    ref.take(1, TimeUnit.NANOSECONDS);
  }

  @Test(expected = TimeoutException.class) public void timeoutMRSWReferenceGet() throws Exception {
    final BlockingReference<String> ref = BlockingReference.newMRSW();
    ref.get(1, TimeUnit.NANOSECONDS);
  }

  @Test(expected = TimeoutException.class) public void timeoutMRSWReferenceTake() throws Exception {
    final BlockingReference<String> ref = BlockingReference.newMRSW();
    ref.take(1, TimeUnit.NANOSECONDS);
  }

  @Test(expected = TimeoutException.class) public void timeoutSRSWReferenceTakeIfTaken() throws Exception {
    final BlockingReference<String> ref = BlockingReference.newSRSW();
    ref.set("blah");
  ...
  @Test(expected = TimeoutException.class) public void timeoutMRSWReferenceTakeIfTaken() throws Exception {
    final BlockingReference<String> ref = BlockingReference.newMRSW();
    ref.set("blah");
    assertSame("blah", ref.take(1, TimeUnit.NANOSECONDS));
    ref.take(1, TimeUnit.NANOSECONDS);
