...
public class PhasedLatchTest {
    @Test
    public void phasesAwait() throws Exception {
    ...
    @Test
    public void phasesAwaitTimeout() throws Exception {
        final PhasedLatch latch = new PhasedLatch();
    ...
    @Test
    public void phasesAwaitPhase() throws Exception {
        final PhasedLatch latch = new PhasedLatch();
    ...
    @Test
    public void phasesAwaitPhaseTimeout() throws Exception {
        final PhasedLatch latch = new PhasedLatch();
